...
- BiT does not officially use any interpolation, but Transformers defaults to BICUBIC interpolation. See [original repo](https://github.com/zzh-tech/BiT/blob/main/data/data_aug.py).
